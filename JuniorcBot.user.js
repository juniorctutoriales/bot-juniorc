// ==UserScript==
// @name        JuniorcBot
// @namespace   JuniorcBot
// @include     http://agar.io/*
// @version     3.56
// @grant       none
// @author      http://www.fb.com/christian.ponce.7146
// ==/UserScript==

var JuniorcBotVersion = 3.56;
...
function getLatestCommit() {
    window.jQuery.ajax({
            ...
            $.get('https://raw.githubusercontent.com/Apostolique/Agar.io-bot/master/Juniorcbot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                var latestVersion = data.replace(/(\r\n|\n|\r)/gm,"");
                latestVersion = latestVersion.substring(latestVersion.indexOf("// @version")+11,latestVersion.indexOf("// @grant"));

                latestVersion = parseFloat(latestVersion + 0.0000);
                var myVersion = parseFloat(JuniorcBotVersion + 0.0000); 
                
                if(latestVersion > myVersion)
                {
                    update("JuniorcBot", "bot.user.js", "https://github.com/Apostolique/Agar.io-bot/blob/" + sha + "/bot.user.js/");
                }
