...
// @namespace   JuniorcLauncher// @include     http://agar.io/*
// @version     3.063
// @grant       none
// @author      https://www.fb.com/christian.ponce.7146
// ==/UserScript==

var JuniorcLauncherVersion = 3.063;
...
function getLatestCommit() {
    window.jQuery.ajax({
            ...
            window.jQuery.get('https://raw.githubusercontent.com/Apostolique/Agar.io-bot/master/launcher.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                var myVersion = parseFloat(JuniorcLauncherVersion + 0.0000);

                if (latestVersion > myVersion) {
                    update("JuniorcLauncher", "launcher.user.js", "https://github.com/Apostolique/Agar.io-bot/blob/" + sha + "/launcher.user.js/");
                }
                ...
                da.prototype = {
                    ...
                    w: function(a) {
                        if (this.N()) {
                            ...
                            !this.n && kb && ":teams" != P ? -1 != ob.indexOf(d) ? (U.hasOwnProperty(d) || (U[d] = new Image, (d == "JuniorcBot" ? U[d].src = "http://i.imgur.com/q5FdCkx.png" : U[d].src = "skins/" +
